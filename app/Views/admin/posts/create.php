        ...
        <div class="box-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="title" value="<?=$_POST['title']?>">
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="date" class="form-control pull-right" id="datepicker" name="date" value="<?=$_POST['date']?>">
              </div>
              <!-- /.input group -->
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea name="description" id="" cols="30" rows="10" class="form-control" ><?=$_POST['description']?></textarea>
          </div>
        </div>
          <div class="col-md-12">
            <div class="form-group">
